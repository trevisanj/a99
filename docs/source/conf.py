...
# a99 configuration, copied from below
#
...
# html_theme = 'haiku'
# html_theme = 'graphite'
# html_theme_path = ["/home/j/Documents/a99/docs"]
...
latex_documents = [
    (master_doc, 'a99.tex', 'a99 Documentation',
     'JT', 'manual'),
]
...
man_pages = [
    (master_doc, 'a99', 'a99Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'a99', 'a99 Documentation',
     author, 'a99', 'Multi-purpose API for Python',
     'Miscellaneous'),
]
